...
$tukhoa = array('union','chr(', 'chr=', 'chr%20', '%20chr', 'wget%20', '%20wget', 'wget(',
	...
	'locate%20', 'grep%20', 'locate(', 'grep(','eval(', 'diff%20', 'kill%20', 'kill(', 'killall',
	...
	'servlet', '/etc/passwd', '[Only registered and activated users can see links]', '~root', '~ftp', '.jsp', '.history',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['recaptcha_response'])) {
		...
		$verify  = file_get_contents($api_url, false, $context);
