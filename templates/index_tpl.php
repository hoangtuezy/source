				...
				<div class="col-sm-6 col-12">
					<div class="congtrinh_item <?=$stt&1?'even':''?>">
						<a href="<?=$item["tenkhongdau"]?>" class="image">
							<img src="thumb/1-250-210/upload/baiviet/<?=$item["photo"]?>" alt="<?=$item["photo"]?>" class="w-100 img-fluid">
						</a>
						<div class="detail">
...
<div id="video">
	<a href="<?=$video[0]["links"]?>">
		<img src="upload/video/<?=$video[0]["photo"]?>" alt="<?=$video[0]["photo"]?>" class="w-100 img-fluid">
	</a>
			...
			<div class="swiper-wrapper">
				<?php foreach($video as $item): ?>
					<div class="swiper-slide">
						<div>
							<a href="<?=$item["links"]?>"><img src="thumb/1-108-108/upload/video/<?=$item["photo"]?>" alt="<?=$item["ten_$lang"]?>"></a>
						</div>
					</div>
				<?php endforeach; ?>
			</div>
