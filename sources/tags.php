...
#các sản phẩm khác======================
	...
	if($idl!=''){
		$sql="select * from #_tags where type='san-pham' and hienthi=1 and tenkhongdau='".$idl."'";
		$d->query($sql);
		...
		$sql = "select ten_$lang,thumb,tenkhongdau,giaban,giacu,mota_$lang,photo,type from $where $limit";
		$d->query($sql);
