...
<form name="supplier" id="validate" class="form" action="index.php?com=yahoo&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			<label>Tên</label>
			<div class="formRight">
                <input type="text" name="name" title="Nhập tên nhân viên hỗ trợ" id="name" class="tipS form-control validate[required]" value="<?=@$item['ten']?>" />
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
			...
			<div class="formRight">
                <input type="text" name="dienthoai" title="Nhập số điện thoại" id="dienthoai" class="tipS form-control validate[required]" value="<?=@$item['dienthoai']?>" />
			</div>
			<div class="clear"></div>
		</div>
         <div class="formRow">
			<label>Zalo</label>
			<div class="formRight">
                <input type="text" name="zalo" title="Nhập địa chỉ zalo" id="zalo" class="tipS form-control" value="<?=@$item['zalo']?>" />
			</div>
			<div class="clear"></div>
		</div> 
        ...
        <div class="formRow">
			<label>Skype</label>
			<div class="formRight">
                <input type="text" name="skype" title="Nhập nick chat skype" id="skype" class="tipS form-control" value="<?=@$item['skype']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			<label>Viber</label>
			<div class="formRight">
                <input type="text" name="viber" title="Nhập nick chat viber" id="viber" class="tipS form-control" value="<?=@$item['viber']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			<label>Email</label>
			<div class="formRight">
                <input type="text" name="email" title="Nhập Email" id="email" class="tipS form-control" value="<?=@$item['email']?>" />
			</div>
			<div class="clear"></div>
		</div>     
