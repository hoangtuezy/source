...
<ul id="menu" class="nav">
  <li class="dash <?=$com=='index'?'active':''?>" id="menu1"><a class=" active" title="" href="index.php"><span>Trang chủ</span></a></li>
  <li class="menu categories_li"><a href="" title="" class="exp"><span>Sản phẩm</span><strong></strong></a>
    <ul class="sub"> 
      <li><a href="index.php?com=product&act=man_list&type=san-pham">DM Cấp 1</a></li>
      <li><a href="index.php?com=product&act=man_cat&type=san-pham">DM Cấp 2</a></li>
     <li><a href="index.php?com=product&act=man&type=san-pham">Sản Phẩm</a></li>
      <li><a href="index.php?com=order&act=man&type=san-pham">Đơn Hàng</a></li>
   </ul>
 </li>
 ...
 <li class="menu categories_li"><a href="" title="" class="exp"><span>Bài viết</span><strong></strong></a>
  <ul class="sub">
   ...
   <li><a href="index.php?com=baiviet&act=man&type=vi-sao-chon">Vì Sao Chọn</a></li>
...
<li class="menu categories_li"><a href="#" title="" class="exp"><span>Thông tin công ty</span><strong></strong></a>
  <ul class="sub">
    ...
    <!-- <li><a href="index.php?com=download&act=man&type=download">Nhạc nền</a></li> -->
  </ul>
</li>
<li class="menu categories_li"><a href="#" title="" class="exp"><span>Slider - Video - Hình ảnh</span><strong></strong></a>
  <ul class="sub">
    <li><a href="index.php?com=photo&act=man_photo&type=slider" title="">Hình ảnh slider</a></li>
     <li><a href="index.php?com=photo&act=man_photo&type=doi-tac" title="">Đối Tác</a></li>
    <li><a href="index.php?com=bannerqc&act=capnhat&type=quangcao" title="">Quảng cáo</a></li>
    <li><a href="index.php?com=lkweb&act=man&type=mxh_top" title="">MXH Top</a></li>
  </ul>
</li>

<li class="menu categories_li"><a href="" title="" class="exp"><span>Seo Page</span><strong></strong></a>
  <ul class="sub"> 
   ...
   <li><a href="index.php?com=component&act=man&type=chinh-sach" title="">Chính Sách</a></li>
