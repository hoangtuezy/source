        ...
        <form action="index.php?com=user&act=login" id="validate" class="form" method="post">
            <fieldset>
                <div class="input-group">
                    ...
                    <div class="col-8">
                    <input type="text" name="username" class="validate[required] form-control" id="username" />
                    </div>
                </div>
                <hr>
                <div class="input-group">
                    <div class="input-group-prepend col-4">
                     ...
                     <div class="col-8">
                    <input type="password" name="password" class="validate[required] form-control" id="pass" />
                </div>
                </div>
                <hr>
                <div class="col-12">
                    <!--<div class="rememberMe"><a href="#" class="forgot-pwd">Bạn quên mật khẩu?</a></div>-->
                    <input type="submit" value="Đăng nhập" class="btn btn-danger float-right logMeIn" />
                    <div class="clear"></div>
                </div>
