	...
	<div class="widget">
		...
		<?php } ?>
		 ...
		 <div class="formRow">
			<label>Link</label>
			<div class="formRight">
                <input type="text" name="Link" title="Nhập link quảng cáo" id="Link" class="form-control" value="<?=@$item['Link']?>" />
			</div>
			<div class="clear"></div>
		</div>	
		<?php }?>
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=product&act=man_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-secondary tipS" original-title="Thoát">Thoát</a>
