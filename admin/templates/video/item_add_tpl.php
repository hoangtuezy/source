...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
                <input type="text" name="links" title="Nhập tên links youtobe" id="ten_en" class="form-control tipS validate[required]" value="<?=@$item['links']?>" />
			</div>
			<div class="clear"></div>
		</div>
	...
	<!--	<div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=video&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-secondary tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
