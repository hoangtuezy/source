		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
			...
			<tbody>
				...
				for($i=0,$count_donhang=count($result_ctdonhang);$i<$count_donhang;$i++){	
					...
					$_color = fetch_array("select * from #_thuoctinh where id='".$result_ctdonhang[$i]['id_color']."' and hienthi=1");
					$_size = fetch_array("select * from #_thuoctinh where id='".$result_ctdonhang[$i]['id_size']."' and hienthi=1");	
