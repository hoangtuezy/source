...
<div class="widget">
  <div class="title" style="padding-bottom:5px;">
    ...
    <form name="search" action="index.php" method="GET" class="form giohang_ser">
      ...
      <input class="form_or form-control" name="keyword" placeholder="Nhập từ khóa.." value="<?=$_GET['keyword']?>" type="text" />
      <input class="form_or form-control" name="ngaybd" id="datefm" type="text" value="<?=$_GET['ngaybd']?>" placeholder="Từ ngày.."/>
      <input class="form_or form-control" name="ngaykt" id="dateto" type="text" value="<?=$_GET['ngaykt']?>" placeholder="Đến ngày.." />
...
<div class="control_frm" style="margin-top:15px;">
  	<div style="float:left;">
    	
        <input type="button" class="btn btn-danger" value="Xoá" onclick="ChangeAction('index.php?com=order&act=man&multi=del');return false;" />
    </div>  
