...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="table withCheck mTable" id="checkAll">
    <thead>
      <tr>
        <td></td>
  ...
  $text .= "<tr {$class}><td><input type=\"checkbox\" name=\"idtable[]\" value=\"" . $row['Name'] . "\" id=\"check".$i."\" /></td><td style=\"text-align:left\" class=\"row1\">&nbsp;<strong><a href='index.php?com=database&act=view_table&type=".$row['Name']."'>" . $row['Name'] . "</a></strong></td>";
  $text .= "<td style=\"text-align:center\" class=\"\">" . $row['Rows'] . "</td>";
  $text .= "<td style=\"text-align:center\" class=\"\">" . $total_data . "</td>";
  $text .= "<td style=\"text-align:center\" class=\"\">" . $total_idx . "</td>";
   $text .= "<td style=\"text-align:center\" class=\"\">" . $data_free . "</td>";
  $text .= "<td style=\"text-align:center\" class=\"\">" . $row['Update_time'] . "</td><td><a href='index.php?com=database&act=view_table&type=".$row['Name']."'>view</a></td></tr>";
  $i ++;
  }
echo $text;
    ?>
