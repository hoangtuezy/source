...
<script type="text/javascript">		
	...
	function select_list()
	{
		...
		window.location ="index.php?com=page&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?><?php if($_REQUEST['type']!='') echo"&type=".$_REQUEST['type']; ?>&id_list="+a.value;	
		return true;
	}	
	...
	function select_cat()
	{
		...
		window.location ="index.php?com=page&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?><?php if($_REQUEST['type']!='') echo"&type=".$_REQUEST['type']; ?>&id_list="+a.value+"&id_cat="+b.value;	
		return true;
	}
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=page&act=add_item<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm Danh mục cấp 3</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=page&act=save_item<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_page.$item['thumb']?>"  alt="NO PHOTO"  /></div>
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>	
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=page&act=man_item<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
