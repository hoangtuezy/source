	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
				<div class="note"> width : 76px , Height : 64px </div>
			</div>
			<div class="clear"></div>
		</div>
        <?php if($_GET['act']=='edit'){?>
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_hinhanh.$item['icon']?>"  alt="NO PHOTO" width="40" /></div>
			</div>
			<div class="clear"></div>
		</div>
		<?php } } ?>
		<div class="formRow">
			<label>Tên</label>
			<div class="formRight">
                <input type="text" name="ten" title="Nhập tên website" id="name" class="tipS validate[required] form-control" value="<?=@$item['ten']?>" />
			</div>
			<div class="clear"></div>
		</div>
        ...
        <div class="formRow">
			<label>Link</label>
			<div class="formRight">
                <input type="text" name="url" title="Nhập link website" id="url" class="tipS validate[required] form-control" value="<?=@$item['url']?>" />
			</div>
			<div class="clear"></div>
		</div>
