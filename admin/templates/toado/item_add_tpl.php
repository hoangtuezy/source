...
<form name="supplier" id="validate" class="form" action="index.php?com=toado&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
    ...
    <?php }?>
        ...
        <div class="formRow lang_hidden lang_vi active">
			<label>Tên</label>
			<div class="formRight">
                <input type="text" name="ten_vi" title="Nhập tên" id="ten_vi" class="form-control tipS validate[required]" value="<?=@$item['ten_vi']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow lang_hidden lang_vi active">
			<label>Địa chỉ</label>
			<div class="formRight">
                <input type="text" name="diachi" title="Nhập địa chỉ" id="diachi" class="form-control tipS validate[required]" value="<?=@$item['diachi']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow lang_hidden lang_vi active">
			...
			<div class="formRight">
                <input type="text" name="dienthoai" title="Nhập số điện thoại" id="dienthoai" class="form-control tipS validate[required]" value="<?=@$item['dienthoai']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow lang_hidden lang_vi active">
			<label>Tọa độ</label>
			<div class="formRight">
				<textarea name="toado" id="toado" cols="30" rows="10" class="form-control"><?=@$item['toado']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=toado&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-secondary tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
