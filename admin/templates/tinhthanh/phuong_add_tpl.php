	...
	function select_list()
	  {
	    ...
	    window.location ="index.php?com=tinhthanh&act=add_phuong&id_list="+a.value; 
	    return true;
	  }
	  ...
	  function select_cat()
	  {
	    ...
	    window.location ="index.php?com=tinhthanh&act=add_phuong&id_list="+a.value+"&id_cat="+b.value; 
	    return true;
	  }
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=tinhthanh&act=add_phuong<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm phường,xã</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=tinhthanh&act=save_phuong<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=tinhthanh&act=man_phuong<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
